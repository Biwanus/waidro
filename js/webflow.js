		...
		window.tram = (function (t) {
					...
					function x(A, Q) {
						...
						return (
							...
							(l.open = function (ae) {
								if (
									((M = {}),
									u(ae) ? (M = ae.call(l, be, te, l, A)) : o(ae) && (M = ae),
									o(M))
								)
									for (var Fe in M) r.call(M, Fe) && (be[Fe] = M[Fe]);
								return u(be.init) || (be.init = A), l;
							}),
							l.open(Q)
						);
					}
			...
			var G = (c.frame = (function () {
				...
				ye = W(function (e) {
						...
						if (E) {
							...
							if (U == "object") {
								...
								be.call(
									...
									E,
									function (ne, qt) {
										ne.span > ce && (ce = ne.span), ne.stop(), ne.animate(qt);
									},
									function (ne) {
										"wait" in ne && (ce = q(ne.wait, 0));
									}
								),
									te.call(this),
									ce > 0 &&
					...
					function A(E) {
						x.call(this, E), be.call(this, E, Fe, It);
					}
					function Q(E) {
				...
				T = W(function (e) {
					...
					function i(s, x, A) {
						return x !== void 0 && (A = x), s in X ? s : A;
					}
					function o(s) {
					...
					(e.init = function (s, x, A, Q) {
						...
						A[2] && (l = A[2]),
							...
							(this.name = l),
							(this.type = A[1]),
							(this.duration = q(x[1], this.duration, u.duration)),
							(this.ease = i(x[2], this.ease, u.ease)),
							(this.delay = q(x[3], this.delay, u.delay)),
				...
				Ce = W(function (e) {
					...
					function i() {
						var l,
							...
							te = A.length;
						if (te)
							for (G(i), S = fe(), l = te; l--; ) (M = A[l]), M && M.render(S);
					}
					function o(l) {
						var S,
							M = t.inArray(l, A);
			...
			var n = t.style,
				...
				v = {
					...
					"border-width": [T, P],
					"border-top-width": [T, P],
					"border-right-width": [T, P],
					"border-bottom-width": [T, P],
					"border-left-width": [T, P],
					"border-spacing": [T, P],
					"letter-spacing": [T, P],
					margin: [T, P],
					"margin-top": [T, P],
					...
					"max-height": [T, B],
					"line-height": [T, ue],
					"scroll-top": [Ae, p, "scrollTop"],
					"scroll-left": [Ae, p, "scrollLeft"],
				},
				J = {};
			m.transform &&
				((v.transform = [Ie]),
			...
			return (
				(t.template = function (a, f, w) {
					...
					var m = RegExp(
						...
						R = 0,
						O = "__p+='";
					a.replace(m, function (ie, T, oe, Ae, Ie) {
						return (
							(O += a.slice(R, Ie).replace(Te, ve)),
							(R = Ie + ie.length),
							T
								? (O +=
										`'+
...
` +
	...
	var Le = he((jt, at) => {
		...
		function Ft(t) {
			...
			ge.contains(qe, t.ready) || qe.push(t.ready);
		}
		function it(t) {
		...
		V.ready = function () {
			(He = !0), Ge ? $t() : ge.each(qe, tt), ge.each(Ye, tt), V.resize.up();
		};
		function tt(t) {
			xe(t) && t();
		}
		...
		ct.define(
			...
			(ft.exports = function (t) {
				...
				c.ready = function () {
					...
					/\.webflow\.io$/i.test(Y) && I.hostname !== Y && (_ = !0),
						_ &&
							!C &&
							(($ = $ || W()),
							X(),
		...
		Xt.define(
			...
			(ht.exports = function () {
				function t(d) {
					...
					function _(p) {
						C(p.target) && (k || q(p.target)) && $(p.target);
					}
					function Y(p) {
						C(p.target) &&
			...
			(pt.exports = function () {
				...
				function k(I) {
					var C = I.target,
						q = C.tagName;
					return (
						(/^a$/i.test(q) && C.href != null) ||
						(/^(button|textarea)$/i.test(q) && C.disabled !== !0) ||
						(/^input$/i.test(q) &&
							/^(button|reset|submit|radio|checkbox)$/i.test(C.type) &&
							!C.disabled) ||
						(!/^(button|input|textarea|select|a)$/i.test(q) &&
							!Number.isNaN(Number.parseFloat(C.tabIndex))) ||
						/^audio$/i.test(q) ||
						(/^video$/i.test(q) && C.controls === !0)
					);
				}
				function D(I) {
					k(I) &&
	...
	var wt = he((rn, gt) => {
		...
		ze.define(
			...
			(gt.exports = function (t, c) {
				...
				function _() {
					(D = b && ze.env("design")),
						(X = ze.env("slug") || I.pathname || ""),
						ze.scroll.off(K),
						(W = []);
					for (var z = document.links, L = 0; L < z.length; ++L) Y(z[L]);
				...
				function Y(z) {
					...
					if (((C.href = L), !(L.indexOf(":") >= 0))) {
						...
						if (!(L === "#" || L === "")) {
							var P = C.href === I.href || L === X || ($.test(L) && j.test(X));
							N(p, q, P);
						}
					}
				}
				function K() {
					...
					c.each(W, function (p) {
						var H = p.link,
							...
							re = P.outerHeight(),
							ue = L * 0.5,
							de = P.is(":visible") && B + re - ue >= z && B + ue <= z + L;
						p.active !== de && ((p.active = de), N(H, q, de));
					});
				}
				function N(z, L, p) {
					var H = z.hasClass(L);
					(p && H) || (!p && !H) || (p ? z.addClass(L) : z.removeClass(L));
				}
				return d;
			})
		);
		...
		Be.define(
			...
			(yt.exports = function (t) {
				var c = {
					...
					q = Be.env("editor") ? ".w-editor-body" : "body",
					$ =
						"header, " +
						q +
						" > .header, " +
	...
	var Et = he((sn, xt) => {
		...
		Kt.define(
			...
			(xt.exports = function (t) {
				...
				function D(b, I, C) {
					var q = t.Event(b, { originalEvent: I });
					t(I.target).trigger(q, C);
				}
	...
	var Ct = he((an, At) => {
		...
		Ke.triggers = {};
		Ke.types = { INTRO: "w-ix-intro" + Tt, OUTRO: "w-ix-outro" + Tt };
